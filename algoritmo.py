"""
Objetivo: Escrever em python o arquivo algoritmo.md
*PSEUDO CODIGO, somente para exemplificar
"""
...
if padaria_aberta:
    ...
    if tem("pao_int") and tem("baguete"):
        pedir(6, "pao int")
        pedir(6, "baguete")
    elif tem("pao_int") and tem("baguete"): 
